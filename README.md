...
|    TOTAL_RECORDS_FOUND     |   7213   | Not that important but if you want somewhat precise estimated time until completion keep it up to date. This option will be removed in future release since it makes no sense to be hardcoded when it can be fetched automatically every time the app is starting. |
